...
public class VendorGroupDTO implements Serializable{
	...
	public boolean equals(Object o) {
		...
		VendorGroupDTO vendorGroupDTO = (VendorGroupDTO) o;
		return Objects.equals(id, vendorGroupDTO.id) && Objects.equals(code, vendorGroupDTO.code) && Objects.equals(name, vendorGroupDTO.name);
	}
